...
public final class BatchGetDatabaseRequest extends GlueCatalogFederationRequest implements
        ToCopyableBuilder<BatchGetDatabaseRequest.Builder, BatchGetDatabaseRequest> {
    private static final SdkField<String> AS_OF_ACCOUNT_ID_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("AsOfAccountId").getter(getter(BatchGetDatabaseRequest::asOfAccountId))
    ...
    private static final SdkField<List<String>> ENTRIES_FIELD = SdkField
            .<List<String>> builder(MarshallingType.LIST)
            .memberName("Entries")
            .getter(getter(BatchGetDatabaseRequest::entries))
    ...
    private static final SdkField<Map<String, String>> REQUEST_CONTEXT_FIELD = SdkField
            ...
            .getter(getter(BatchGetDatabaseRequest::requestContextAsStrings))
    ...
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(AS_OF_ACCOUNT_ID_FIELD,
            ENTRIES_FIELD, REQUEST_CONTEXT_FIELD));
    ...
    private BatchGetDatabaseRequest(BuilderImpl builder) {
        super(builder);
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        if (!(obj instanceof BatchGetDatabaseRequest)) {
            return false;
        }
        BatchGetDatabaseRequest other = (BatchGetDatabaseRequest) obj;
        return Objects.equals(asOfAccountId(), other.asOfAccountId()) && hasEntries() == other.hasEntries()
                && Objects.equals(entries(), other.entries()) && hasRequestContext() == other.hasRequestContext()
    ...
    public final String toString() {
        return ToString.builder("BatchGetDatabaseRequest").add("AsOfAccountId", asOfAccountId())
    ...
    private static <T> Function<Object, T> getter(Function<BatchGetDatabaseRequest, T> g) {
        return obj -> g.apply((BatchGetDatabaseRequest) obj);
    }
    ...
    public interface Builder extends GlueCatalogFederationRequest.Builder, SdkPojo,
            CopyableBuilder<Builder, BatchGetDatabaseRequest> {
        /**
         ...
         * @return Returns a reference to this object so that method calls can be chained together.
         */
        Builder entries(Collection<String> entries);
         ...
         * @return Returns a reference to this object so that method calls can be chained together.
         */
        Builder entries(String... entries);
    ...
    static final class BuilderImpl extends GlueCatalogFederationRequest.BuilderImpl implements Builder {
        ...
        private List<String> entries = DefaultSdkAutoConstructList.getInstance();
        ...
        private BuilderImpl(BatchGetDatabaseRequest model) {
            super(model);
        ...
        public final Collection<String> getEntries() {
        ...
        public final void setEntries(Collection<String> entries) {
            this.entries = BatchGetDatabaseRequestEntryListCopier.copy(entries);
        }

        @Override
        @Transient
        public final Builder entries(Collection<String> entries) {
            this.entries = BatchGetDatabaseRequestEntryListCopier.copy(entries);
            return this;
        }
        ...
        @Transient
        @SafeVarargs
        public final Builder entries(String... entries) {
        ...
        @Override
        public BatchGetDatabaseRequest build() {
            return new BatchGetDatabaseRequest(this);
        }
