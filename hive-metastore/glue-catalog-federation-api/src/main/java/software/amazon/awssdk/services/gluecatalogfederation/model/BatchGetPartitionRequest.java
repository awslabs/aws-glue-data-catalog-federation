...
public final class BatchGetPartitionRequest extends GlueCatalogFederationRequest implements
    ...
    private static final SdkField<CallerIdentity> CALLER_IDENTITY_FIELD = SdkField
            ...
            .getter(getter(BatchGetPartitionRequest::callerIdentity)).setter(setter(Builder::callerIdentity))
    ...
    private static final SdkField<Map<String, String>> REQUEST_CONTEXT_FIELD = SdkField
            ...
            .getter(getter(BatchGetPartitionRequest::requestContext))
    ...
    public interface Builder extends GlueCatalogFederationRequest.Builder, SdkPojo,
         ...
         * {@link software.amazon.awssdk.services.gluecatalogfederation.model.PartitionValue.Builder} avoiding the need
         * to create one manually via
         * {@link software.amazon.awssdk.services.gluecatalogfederation.model.PartitionValue#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes,
         * {@link software.amazon.awssdk.services.gluecatalogfederation.model.PartitionValue.Builder#build()} is called
         * immediately and its result is passed to {@link #entries(List<PartitionValue>)}.
         *
         * @param entries
         *        a consumer that will call methods on
         *        {@link software.amazon.awssdk.services.gluecatalogfederation.model.PartitionValue.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         * @see #entries(java.util.Collection<PartitionValue>)
         */
