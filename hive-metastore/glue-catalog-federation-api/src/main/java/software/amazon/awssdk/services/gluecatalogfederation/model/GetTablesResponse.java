...
public final class GetTablesResponse extends GlueCatalogFederationResponse implements
        ToCopyableBuilder<GetTablesResponse.Builder, GetTablesResponse> {
    private static final SdkField<List<Table>> TABLES_FIELD = SdkField
            .<List<Table>> builder(MarshallingType.LIST)
            .memberName("Tables")
            .getter(getter(GetTablesResponse::tables))
    ...
    private static final SdkField<String> NEXT_TOKEN_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("NextToken").getter(getter(GetTablesResponse::nextToken)).setter(setter(Builder::nextToken))
    ...
    public final String toString() {
        return ToString.builder("GetTablesResponse").add("Tables", hasTables() ? tables() : null).add("NextToken", nextToken())
                .build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<GetTablesResponse, T> g) {
        return obj -> g.apply((GetTablesResponse) obj);
    }
    ...
    public interface Builder extends GlueCatalogFederationResponse.Builder, SdkPojo, CopyableBuilder<Builder, GetTablesResponse> {
        /**
