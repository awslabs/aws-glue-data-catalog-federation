...
public enum Comparator {
    ...
    private static final Map<String, Comparator> VALUE_MAP = EnumUtils.uniqueIndex(Comparator.class, Comparator::toString);
     ...
     *
     * @return a {@link Set} of known {@link Comparator}s
     */
    public static Set<Comparator> knownValues() {
        Set<Comparator> knownValues = EnumSet.allOf(Comparator.class);
