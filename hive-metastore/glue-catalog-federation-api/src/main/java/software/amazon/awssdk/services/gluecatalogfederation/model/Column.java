...
public final class Column implements SdkPojo, Serializable, ToCopyableBuilder<Column.Builder, Column> {
    private static final SdkField<String> NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING).memberName("Name")
            .getter(getter(Column::name)).setter(setter(Builder::name))
            .traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Name").build()).build();

    private static final SdkField<String> TYPE_FIELD = SdkField.<String> builder(MarshallingType.STRING).memberName("Type")
            .getter(getter(Column::type)).setter(setter(Builder::type))
    ...
    private static final SdkField<String> COMMENT_FIELD = SdkField.<String> builder(MarshallingType.STRING).memberName("Comment")
            .getter(getter(Column::comment)).setter(setter(Builder::comment))
    ...
    private static final SdkField<Map<String, String>> PARAMETERS_FIELD = SdkField
            ...
            .getter(getter(Column::parameters))
    ...
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(NAME_FIELD, TYPE_FIELD,
            COMMENT_FIELD, PARAMETERS_FIELD));
    ...
    private Column(BuilderImpl builder) {
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        return Objects.equals(name(), other.name()) && Objects.equals(type(), other.type())
                && Objects.equals(comment(), other.comment()) && hasParameters() == other.hasParameters()
    ...
    public final String toString() {
        return ToString.builder("Column").add("Name", name()).add("Type", type()).add("Comment", comment())
    ...
    private static <T> Function<Object, T> getter(Function<Column, T> g) {
        return obj -> g.apply((Column) obj);
    }
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, Column> {
        /**
    ...
    static final class BuilderImpl implements Builder {
        ...
        private BuilderImpl(Column model) {
            name(model.name);
            type(model.type);
